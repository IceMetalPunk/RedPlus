...
public class ScoreRotationPitch extends ScoreDummyCriteria {

	public ScoreRotationPitch(String p_i2312_1_) {
		super(p_i2312_1_);
	}
	...
	public int func_96635_a(List p_96635_1_) {
		...
		for (Iterator iterator = p_96635_1_.iterator(); iterator.hasNext(); f += entityplayer.rotationPitch) {
