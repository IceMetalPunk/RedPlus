...
public class ModelQuartzGolem extends ModelBase {
	...
	public ModelQuartzGolem() {
		this(0.0F);
	}

	public ModelQuartzGolem(float p_i1161_1_) {
		this(p_i1161_1_, -7.0F);
	}

	public ModelQuartzGolem(float p_i1162_1_, float p_i1162_2_) {
		short short1 = 128;
		short short2 = 128;
	...
	public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
		EntityIronGolem entityirongolem = (EntityQuartzGolem) p_78086_1_;
