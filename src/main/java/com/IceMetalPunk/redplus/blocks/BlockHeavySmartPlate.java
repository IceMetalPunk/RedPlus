...
public class BlockHeavySmartPlate extends BlockBasePressurePlate {

	protected BlockHeavySmartPlate() {
		super("redplus:iron_smart_plate", Material.iron);
	}
